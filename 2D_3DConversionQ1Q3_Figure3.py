...
from KeckIntensityStep2 import New_INTSQ1, New_INTSQ3
...
New_INTSQ1 = New_INTSQ1 + New_INTSQ3
...
cbar = plt.colorbar()
cbar.set_label(r'Intensity (${\mu}W$ ' + '$m^{-2}$ ' + '$sr^{-1}$) ' + u'\u00B1' + ' ' + str("{:.2f}".format(0.10)) + ' ${\mu}W$ ' + '$m^{-2}$ ' + '$sr^{-1}$', fontsize=20) 
...
np.save('Step5ConversionQ1Q3.npy', KECK_06_MAP)