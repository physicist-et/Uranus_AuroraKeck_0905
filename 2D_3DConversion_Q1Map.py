...
from KeckIntensityStep2 import New_INTSQ1

#Testing script for how to get Uranus at Keck 2006
...
cbar = plt.colorbar()
cbar.set_label(r'Intensity (${\mu}W$ ' + '$m^{-2}$ ' + '$sr^{-1}$) ' + u'\u00B1' + ' ' + str("{:.2f}".format(0.08)) + ' ${\mu}W$ ' + '$m^{-2}$ ' + '$sr^{-1}$', fontsize=20) 
...
#np.save('Step5Conversion.npy', KECK_06_MAP)